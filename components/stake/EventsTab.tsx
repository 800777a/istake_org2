...
const EventsTab: React.FC<EventsTabProps> = ({ events, currentEvent, onRefresh, onSetActive }) => {
    ...
    return (
        <div id="events-tab-container" className="space-y-6">
            ...
            <div id="create-event-form" className="bg-white p-8 rounded shadow-lg border border-indigo-100 animate-fade-in mb-8">
                <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-6 items-end">
                        <div className="flex-1 min-w-[200px]">
                            ...
                            <input 
                                ...
                                type="date" 
                                className="w-full border border-slate-200 rounded px-4 py-2.5 text-sm font-bold focus:ring-2 focus:ring-blue-100 focus:border-blue-500 outline-none bg-slate-50 text-slate-900 transition-all"
                                value={newEventDate}
                        ...
                        <button 
                            ...
                            className="bg-blue-600 text-white px-8 py-2.5 rounded font-black hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center text-sm shadow-lg shadow-blue-100 transition-all h-[44px] active:scale-95"
                        >
            ...
            <div id="events-list-container" className="bg-white rounded shadow-lg border border-indigo-100 overflow-hidden animate-fade-in">
                                            ...
                                            {event.status === 'completed' ? (
                                                ...
                                                <div className="relative inline-block w-full">
                                                    <select 
                                                        ...
                                                        className={`
                                                            w-full appearance-none border rounded px-3 py-1.5 pr-8 font-black text-xs focus:outline-none focus:ring-2 focus:ring-indigo-100 transition-all cursor-pointer
                                                ...
                                                <div className="flex items-center justify-end gap-1.5">
                                                    ...
                                                    {!isCurrent && event.status !== 'completed' && (
                                                        <button 
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-amber-600 bg-amber-50 hover:bg-amber-100 rounded transition-colors border border-amber-200"
                                                        >
                                                    ...
                                                    {event.status === 'completed' ? (
                                                        <button 
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-sky-700 bg-sky-50 hover:bg-sky-100 rounded transition-colors border border-sky-200 flex items-center gap-1.5"
                                                        >
                                                        ...
                                                        <button 
                                                            ...
                                                            className="px-3 py-1.5 text-xs font-bold text-slate-600 bg-slate-50 hover:bg-slate-100 rounded transition-colors border border-slate-200 flex items-center gap-1.5"
                                                        >
